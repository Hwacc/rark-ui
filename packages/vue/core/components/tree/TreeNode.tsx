...
import { tvTreeBranch } from '@rui-ark/themes/crafts/tree'
...
export default defineComponent({
  ...
  setup(props, { attrs, slots }) {
    const { node, indexPath, keyMap, ui } = toRefs(props)
                          ...
                          <TreeView.BranchControl class={tvBranch.control({ class: uUi.branchControl, ...theme.value })}>
                            {
                              slots.branch
                                ...
                                : (
                                    <>
                                      <div class={tvBranch.title({ class: uUi.branchTitle, ...theme.value })}>
                                        {renderIcon(
                                          {
                                            node: uNode,
                                            state: nodeState,
