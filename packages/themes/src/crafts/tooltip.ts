...
export const tvTooltip = tv(
  {
    slots: {
      content: [
        ...
        'motion-opacity-in',
        'motion-scale-in-95',
        'data-[placement=bottom]:motion-translate-y-in-[.5rem]',
        'data-[placement=top]:-motion-translate-y-in-[.5rem]',
        'data-[placement=left]:motion-translate-x-in-[.5rem]',
        'data-[placement=right]:-motion-translate-x-in-[.5rem]',
